public class Grid {
    ...
    public Grid() {
        ...
        kingdom[0][1] = new Place("Hall",
                "You enter a hallway. The walls have amatuer art and the floor is covered in an ugly carpet.");
        kingdom[0][2] = new Place("Kitchen",
                "The kitchen has dirty dishes in the sink and the damp musky smell of stagnent water.");
        kingdom[0][3] = new Place("Bathroom", "You enter a bathroom that is surprisingly clean.");

        kingdom[1][0] = new Place("Guest Bedroom",
                "This room has a well made bed and a dresser that has no clothes in it. There are dark drapes covering the window blocking any light from outside.");
        kingdom[1][1] = new Place("Hall",
                "You enter another hallway. The floors are covered in parquet hardwood that was beginning to buckle in places.");
        kingdom[1][2] = new Place("Master",
                "The master bedroom has a large King size bed with floral bedding and a small television on a dresser near the closet");
        kingdom[1][3] = new Place("Master Closet",
                "The master closet has only women's clothing that is at least a decade out of style.");
        ...
        kingdom[1][0].addFoe(new Foe("Toby", 100000));        kingdom[0][3].addFoe(new Foe("Evil Goblin", 10));
